        ...
        >
          ...
          <ScrollView>
              <Card>
                ...
                <Card.Cover
                  source={{ uri: this.state.movie[0].image }}
                />
                <Card.Content>
                  <Paragraph>{this.state.movie[0].plot}</Paragraph>
                </Card.Content>
                <Card.Actions>
                  <Button onPress={() => this.props.navigation.navigate("Movie0Av")}>Movie info</Button>
                </Card.Actions>
              <Divider />
                <Card.Title title={this.state.movie[1].title} />
                <Card.Cover
                  source={{ uri: this.state.movie[1].image }}
                />
                <Card.Content>
                  <Paragraph>{this.state.movie[1].plot}</Paragraph>
                </Card.Content>
                <Card.Actions>
                  <Button onPress={() => this.props.navigation.navigate("Movie1Av")}>Movie info</Button>
                </Card.Actions>
                <Divider />
                <Card.Title title={this.state.movie[2].title} />
                <Card.Cover
                  source={{ uri: this.state.movie[2].image }}
                />
                <Card.Content>
                  <Paragraph>{this.state.movie[2].plot}</Paragraph>
                </Card.Content>
                <Card.Actions>
                  <Button onPress={() => this.props.navigation.navigate("Movie2Av")}>Movie info</Button>
                </Card.Actions>
              </Card>
          </ScrollView>
          )}
